...
whiptail --msgbox "Thanks for mining with us!\nLet's do the last steps to configure your datumbox." 0 0
...
dpkg-reconfigure -pmedium bitcoin-knots datum-gateway

whiptail --msgbox "You datum box is now configured!" 0 0